            ...
            public boolean singleTapConfirmedHelper(GeoPoint p) {
                ...
                try {
                    ...
                    if (addresses != null && !addresses.isEmpty()) {
                        ...
                        Toast.makeText(MapActivity.this, "Location: " + locationName, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(MapActivity.this, "Coordinates: " + latitude + ", " + longitude, Toast.LENGTH_SHORT).show();
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                    Toast.makeText(MapActivity.this, "Coordinates: " + latitude + ", " + longitude, Toast.LENGTH_SHORT).show();
